package br.com.dotofocodex.android_sample.service.android;
...
import br.com.dotofocodex.android_sample.activity.MainActivity;
...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private void onFloatingWidgetClick() {
        if (isViewCollapsed()) {
            ...
            Toast.makeText(this.getApplicationContext(), "Abrindo chat...", Toast.LENGTH_SHORT).show();
